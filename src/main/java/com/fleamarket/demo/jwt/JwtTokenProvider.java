package com.fleamarket.demo.jwt;//
...
public class JwtTokenProvider {
    ...
    public String createToken(String userPk) {
        ...
        Date now = new Date();
        return Jwts.builder().setClaims(claims).setIssuedAt(now).setExpiration(new Date(now.getTime() + 300000L)).signWith(SignatureAlgorithm.HS256, this.secretKey).compact();
    }
